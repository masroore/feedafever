 ...
 **************************************************************************/
function SIDB($database = '', $username = '', $password = '', $server = 'localhost', $api = null)
{ // :SIDB
    if (null == $api) {
...
class SIDB
{
    ...
    public $result = false;			// :varies by API or false
    public $sql = ''; 				// :string, the most recent sql query
    ...
    // final methods
    public function parse_server($server)
    { // :array
        // eg. localhost:3306
...
class SIDB_MySQL extends SIDB
{
    ...
    public function connect($database = '', $username = '', $password = '', $server = 'localhost')
    {
        if (false !== ($this->mysql = @mysql_connect($server, $username, $password))) {
