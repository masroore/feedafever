...
//    $v_path = "./";
      ...
      public function properties()
      {
          ...
          if (@is_file($this->zipname)) {
              ...
              if (0 == ($this->zip_fd = @fopen($this->zipname, 'r'))) {
                  $this->privSwapBackMagicQuotes();
      ...
      public function privAdd($p_filedescr_list, &$p_result_list, &$p_options)
      {
          ...
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, "Open file in binary read mode");
          if (0 == ($v_zip_temp_fd = @fopen($v_zip_temp_name, 'w'))) {
              $this->privCloseFd();
              $this->privSwapBackMagicQuotes();
          ...
          if ('ok' == $p_entry['status']) {
              ...
              if (!(($p_entry['external'] & 0x00000010) == 0x00000010)) {
                  ...
                  if (0 == $p_entry['compression']) {
                      ...
                      if (0 == ($v_dest_file = @fopen($p_entry['filename'], 'w'))) {
...
//      if ($p_entry['compressed_size'] == $p_entry['size'])
      ...
      public function privDuplicate($p_archive_filename)
      {
          ...
          // ----- Open the temporary file in write mode
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, "Open file in binary read mode");
          if (0 == ($v_zip_temp_fd = @fopen($p_archive_filename, 'r'))) {
              $this->privCloseFd();
